<template>
  <div class="container-md">
      <div class="row align-items-center">
        <div class="col m-3 text-start" v-show="dataStore.expInfo.usuario.senhaDefinida">
          <!-- <form> -->
            <div class="mb-3">
...
export default {
  ...
  methods: {
    ...
    autenticar(){
      ...
      api.put(`/password/${dataStore.expInfo.usuario.id}/${dataStore.expInfo.autenticacao.id}`, bodyParam).then(response => {
